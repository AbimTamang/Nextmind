...
import { Category, Course, Enrollment } from "@nextminds/db";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link
          ...
          className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium px-6 py-2.5 bg-gradient-to-r from-teal-500 to-blue-600 text-white shadow hover:shadow-lg hover:shadow-teal-200/60 transition-all active:scale-[0.98]"
        >
          <Plus size={16} />
          New Course
        </Link>
