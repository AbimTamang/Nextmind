...
/**
 * Re-exported so consumers have a single entry point. Reaching into
 * "@nextminds/db/models/course" would couple callers to the folder layout and
 * make it impossible to move a model without a cross-repo change.
 */
export { createId } from "./id";
export { cleanConnectionString, isLocalDatabase, sslOptions } from "./connection";
export { sequelize } from "./sequelize";

/** Value objects stored on Course, and the singleton id for SiteSetting. */
export type { CurriculumModule, Faq } from "./models/course";
export { SITE_SETTING_ID } from "./models/site-setting";
